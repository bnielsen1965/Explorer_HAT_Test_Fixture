...
runSetupScripts() {
	declare -a scripts=("overlay-install.sh" "nodejs-install.sh" "pi-buttons-install.sh" "eeprom-utils-install.sh" "ccprog-install.sh" "rftest-install.sh" "echo_server-install.sh" "exhattester-install.sh")
